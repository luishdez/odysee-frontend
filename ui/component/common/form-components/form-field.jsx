          ...
          return (
            <fieldset-section>
              <TextareaWrapper
                ...
                closeSelector={() => setShowSelectors(false)}
                ...
                {hideSuggestions ? (
                  ...
                  <React.Suspense fallback={null}>
                    <TextareaWithSuggestions
                      ...
                      toggleSelectors={() => setShowSelectors(!showSelectors)}
                      handleTip={handleTip}
...
function TextareaWrapper(wrapperProps: TextareaWrapperProps) {
  ...
  return slimInput ? (
    !isDrawerOpen ? (
      ...
      <Drawer className="comment-create--drawer" anchor="bottom" open onClose={handleCloseAll}>
        {children}
